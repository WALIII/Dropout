...
% %  
%  % Cell 1
% for i = 1:26; plot(SCell(idx(i),:)+counter*n,'g'); hold on; 
...
% 
% % Cell 2
% for i = 26:195; plot(SCell(idx(i),:)+counter*n,'b'); hold on;
...
% 
% % Cell 3
% for i = 220:295; plot(SCell(idx(i),:)+counter*n,'r'); hold on; 
...
% 
% % Cell 4;
% for i = 300:340; plot(SCell(idx(i),:)+counter*n,'c'); hold on;
